...
class ApiVersionMixin:
    ...
    def get_deprecated_and_obsolete_versions(cls):
        ...
        if deprecated is None or obsolete is None:
            API_VERSION_DEPRECATION_OFFSET = getattr(
                settings, "API_VERSION_DEPRECATION_OFFSET", None
            )
            API_VERSION_OBSOLETE_OFFSET = getattr(
                settings, "API_VERSION_OBSOLETE_OFFSET", None
            )
