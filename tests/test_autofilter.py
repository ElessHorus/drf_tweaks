...
@autofilter(
    extra_ordering=("non_indexed_fk",),
    extra_filter=("non_indexed_int", "some_property"),
)
...
class TestAutoFilter(TestCase):
    ...
    def test_adding_ordering_fields(self):
        self.assertEqual(
            set(SampleApiV1.ordering_fields),
            {
                "id",
                "fk",
                "indexed_int",
    ...
    def test_integration_filtering(self):
        ...
        response = self.client.get(
            reverse("autofilter_test"), data={"nullable_field__isnull": True}
        )
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get(
            reverse("autofilter_test"), data={"nullable_field__isnull": False}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        ...
        response = self.client.get(
            reverse("autofilter_test"), data={"id": self.smfa1.id}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.smfa1.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"), data={"indexed_int__lt": 2}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.smfa1.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"),
            data={"indexed_int__lte": 2, "indexed__gt": 0},
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 2)
        self.assertEqual(response.data[0]["id"], self.smfa1.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"),
            data={"indexed_int__lte": 2, "indexed_int__gt": 1},
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.smfa2.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"),
            data={"indexed_text__icontains": "Orem"},
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.smfa2.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"),
            data={"indexed_text__istartswith": "lOr"},
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.smfa2.id)
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"),
            data={"indexed_text__istartswith": "lr"},
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_integration_ordering(self):
        ...
        response = self.client.get(
            reverse("autofilter_with_class_test"), data={"ordering": "indexed_int"}
        )
        self.assertEqual(response.status_code, 200)
        self.assertGreater(response.data[1]["id"], response.data[0]["id"])
